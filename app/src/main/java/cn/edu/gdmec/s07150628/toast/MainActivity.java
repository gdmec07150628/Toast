package cn.edu.gdmec.s07150628.toast;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void bl(View v){
        Toast.makeText(this,"hahahahha,我早就会啦",Toast.LENGTH_LONG).show();
    }
    ...
    public void b3(View v){
        Toast toast=Toast.makeText(this,"我是小黄人-图文展示",Toast.LENGTH_LONG);
